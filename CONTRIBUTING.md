# Contributing to Spaceload

Thank you for your interest in contributing to `spaceload`! This document covers everything you need to get started.
...
3. Add the upstream remote so you can pull in future changes:
   ...
   ```bash
   git remote add upstream https://github.com/tomjosetj31/spaceload
   ```
...
Adapters live in `spaceload/adapters/` and teach `spaceload` how to record and replay a specific integration (browser, VPN, IDE, terminal app, etc.).

1. Create a new file: `spaceload/adapters/<name>_adapter.py`.
2. Implement the adapter class — follow the pattern of an existing adapter (e.g. `chrome_adapter.py`) as a reference.
3. Register the adapter in `spaceload/adapters/__init__.py` (or wherever adapters are loaded).
...
Use [GitHub Issues](https://github.com/tomjosetj31/spaceload/issues) to report bugs or request features.
...
- Relevant log output from `~/.spaceload/daemon.log` or `~/.spaceload/replay.log`.

---

Thank you for helping make `spaceload` better!
